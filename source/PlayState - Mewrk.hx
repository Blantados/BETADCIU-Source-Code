...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if (curStage == 'staged3')	
		{
			dad = new Character(100, 100, 'dad-mad');
			boyfriend = new Boyfriend(770, 450, 'bf');
			dad = new Character(100, 200, 'senpaighosty');
			boyfriend = new Boyfriend(770, 450, 'monika-angry');
			boyfriend = new Boyfriend(770, 450, 'selever');
			dad = new Character(100, 100, 'sarvente');
			boyfriend = new Boyfriend(770, 450, 'bf-carol');
			dad = new Character(100, 25, 'kou');
			boyfriend = new Boyfriend(770, 450, 'sky-mad');
			dad = new Character(100, 100, 'crazygf');
			boyfriend = new Boyfriend(770, 450, 'pico');
			dad = new Character(100, 100, 'nene');
			boyfriend = new Boyfriend(770, 450, 'opheebop');
			dad = new Character(100, 100, 'garcello');
			boyfriend = new Boyfriend(770, 450, 'tabi-crazy');
			dad = new Character(100, 100, 'agoti-mad');
			boyfriend = new Boyfriend(770, 450, 'tom2');
			dad = new Character(100, 25, 'tord2');
			...
			dad = new Character(100, 100, 'bf-aloe');
			boyfriend = new Boyfriend(770, 450, 'impostor');
			dad = new Character(100, 100, 'nonsense');
			boyfriend = new Boyfriend(770, 450, 'anchor');
			dad = new Character(100, 25, 'liz');
			boyfriend = new Boyfriend(770, 450, 'bf-blantad');
			dad = new Character(100, 100, 'rebecca');
			boyfriend = new Boyfriend(770, 450, 'bf-sans');
			dad = new Character(100, 100, 'chara');
			boyfriend = new Boyfriend(770, 450, 'botan');
			dad = new Character(100, 100, 'tankman');
			boyfriend = new Boyfriend(770, 450, 'bf-exgf');
			dad = new Character(100, 100, 'miku-mad');
			boyfriend = new Boyfriend(770, 450, 'updike');
			boyfriend = new Boyfriend(770, 450, 'whittyCrazy');
			dad = new Character(dad.x, dad.y, SONG.player2);
			boyfriend = new Boyfriend(boyfriend.x, boyfriend.y, SONG.player1);
		}	
		...
		if (SONG.song.toLowerCase() == 'deathmatch')	
		{
			dad = new Character(100, 100, 'tankman-mad');
			gf = new Character(100, 200, 'ruv-mad');		
			boyfriend = new Boyfriend(770, 450, 'hd-monika-angry');
			boyfriend = new Boyfriend(770, 450, 'dad-sad');
			boyfriend = new Boyfriend(770, 450, 'hd-senpai');
			boyfriend = new Boyfriend(770, 450, 'dad-sad-pixel');	
			gf = new Character(gf.x, gf.y, gfVersion);	
			boyfriend = new Boyfriend(boyfriend.x, boyfriend.y, SONG.player1);
			dad = new Character(dad.x, dad.y, SONG.player2);
		}
		...
		{
			dad = new Character(0, 0, 'gf1');
			boyfriend = new Boyfriend(0, 0, 'bf1');
			dad = new Character(0, 0, 'gf2');
			boyfriend = new Boyfriend(0, 0, 'bf2');
			dad = new Character(0, 0, 'gf3');
			boyfriend = new Boyfriend(0, 0, 'bf3');
			dad = new Character(0, 0, 'gf4');
			boyfriend = new Boyfriend(0, 0, 'bf4');
			dad = new Character(0, 0, 'gf5');
			boyfriend = new Boyfriend(0, 0, 'bf5');
			dad = new Character(dad.x, dad.y, SONG.player2);
			boyfriend = new Boyfriend(boyfriend.x, boyfriend.y, SONG.player1);
		}
		...
		if (SONG.song.toLowerCase() == 'manifest')	
		{
			...
			dad = new Character(0, 100, 'hd-monika-angry');
		...
		{
			var characters:String = Assets.getText(Paths.txt(songLowercase  + "/preload"));
			var charAmount:Array<String> = characters.split('\n');

			for (i in charAmount)
			{
				dad = new Character (0, 0, i);
			}
		}*/
	...
	function doPreload(?i:String ='bf')
	{
	...
	override public function update(elapsed:Float)
	{
		...
		if (generatedMusic && PlayState.SONG.notes[Std.int(curStep / 16)] != null)
		{
			...
			if (PlayState.SONG.notes[Std.int(curStep / 16)].mustHitSection && camFollow.x != boyfriend.getMidpoint().x - 100)
			{
				...
				if (curStage == 'churchsarv' || curStage == 'churchselever' || curStage == 'churchruv')
				{
					switch (curSong)
					{
						case 'Ruvbattle':
