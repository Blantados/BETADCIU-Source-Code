...
function update (elapsed)
	...
	if centerArrows then
		for i=4,7 do
			setActorX(_G['defaultStrum'..i..'X'] - 300, i)
		end
	end
end
...
function beatHit(beat)
	...
	if curStep >= 1024 and curStep < 1152 or curStep >= 1536 and curStep < 1648 then
		setCamZoom(0.93)
	end
end
...
--[[default positions for characters:
    ...
    changeDadCharacter('dad', 430, 300)
...
function stepHit (step) -- do nothing
	...
	if curStep == 256 then
		...
		changeStage('churchsarvdark')
		changeGFCharacter('gf-tea', 250, -70)
		changeDadCharacter('sarvente-dark', -50, 60)
		changeBoyfriendCharacter('bf-demoncesar', 830, 400)
	end

	if curStep == 384 then
		changeStage('incident')
		setDefaultCamZoom(1)
		setBFStaticNotes('trollge')
		changeGFCharacter('gf-tea-nospeaker-trollge', 540, 130)
		changeDadCharacter('trollge', 100, 150)
		changeBoyfriendCharacter('bf-demoncesar-trollge', 830, 400)
	end
	...
	if curStep == 512 then 
		...
		changeDadCharacter('bf-carol', 100, 450)
		changeBoyfriendCharacter('bf-demoncesar', 830, 400)
		followDadXOffset = 50
	end
	...
	if curStep == 640 then
		followDadXOffset = 0
		changeStage('garStage')
		changeGFCharacter('gf-tea', 400, 130)
		changeDadCharacter('garcello', 100, 100)
		changeBoyfriendCharacter('bf-demoncesar', 930, 400)
	end

	if curStep == 768 then
		changeStage('ripdiner')
		setupNoteSplash('-fever')
		setBFStaticNotes('party-crasher')
		changeGFCharacter('gf-tea', 330, 330)
		changeDadCharacter('yukichi-police', -30, 450)
		changeBoyfriendCharacter('bf-demoncesar', 870, 615)
	end
	...
	if curStep == 992 then
		...
		changeGFCharacter('gf-tea-nospeaker', 530, 290)
        changeDadCharacter('cyrix-crazy', 100, 100)
		changeBoyfriendCharacter('bf-demoncesar', 830, 400)
        characterZoom('gf', 0.85)
	end

	if curStep == 1024 then --1024
		changeStage('ron');
		changeGFCharacter('gf-tea', 400, 130)
	...
	if curStep == 1280 then 	
        ...
        changeGFCharacter('gf-tea-nospeaker', 780, -80)
        changeDadCharacter('agoti-mad', -50, 220)
        changeBoyfriendCharacter('bf-demoncesar', 930, 430) 
		agotiArrows = true
        sway = true
	end
	...
	if curStep == 1408 then
		...
		camHudAngle = 0
        cameraAngle = 0
		changeStage('genocide')
		setBFStaticNotes('tabi')
		changeGFCharacter('gf-tea-nospeaker', 1300, 130)
		changeDadCharacter('tabi-crazy', -200, 150)
		changeBoyfriendCharacter('bf-demoncesar', 830, 400)
	end

	if curSstep == 1409 then
		resetArrows = false;
	end

	if curStep == 1536 then
		changeStage('manifest')
		setBFStaticNotes('normal')
		changeGFCharacter('gf-tea-crucified', 480, -55)
		changeDadCharacter('sky-mad', 120, 95)
		changeBoyfriendCharacter('bf-demoncesar', 890, 215)
	end

	if curStep == 1664 then --1664
		changeStage('neko-bedroom')
		strumLine1Visible = false
		centerArrows = true
		setActorAlpha(0, 'gf')
		changeDadCharacter('neko-crazy', 50, 380)
		changeBoyfriendCharacter('bf-demoncesar', 960, 400)
	end

	if curStep == 1792 then
		centerArrows = false
		strumLine1Visible = true
		changeStage('destroyedpaper')
		setBFStaticNotes('sketchy')
		changeGFCharacter('gf-tea-bw', 200, 130)
		changeDadCharacter('tornsketchy', -130, 265)
		changeBoyfriendCharacter('bf-demoncesar-bw', 830, 400)
	end

	if curStep == 1920 then
		changeStage('stare')
		setBFStaticNotes('starecrown')
		changeGFCharacter('gf-tea', 400, 130)
		changeDadCharacter('starecrown', -50, 50)
		changeBoyfriendCharacter('bf-demoncesar', 830, 400)
	end
	...
	if curStep == 2048 then
		changeStage('tank2')
		setBFStaticNotes('normal')
		changeGFCharacter('gf-tea-tankmen', 220, 100)
		changeDadCharacter('tankman', 20, 340)
		changeBoyfriendCharacter('bf-demoncesar', 870, 400)
	end
end